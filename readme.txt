...
Changes:---------------------------------------------------
1.0.2.0 - 7/21/2008
	added multimedia controls
	save files no longer compatible with whiteboard
1.0.1.0 - 7/19/2008
	added custom fields to save data for both save files and registry
	clicking on button title simulates click from wiimote(Note: there is no keypress up when using this, so when using custom keys, you may have to hit the actual keyboard button a couple times before it will work again)